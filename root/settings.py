...
SECRET_KEY = 'django-insecure-5&(q$9!6@7$vt)+m#h#01ju#og#wu)e0d5h_a^s-#1_=!kj6y$'
...
MIDDLEWARE = [
    ...
    'root.middlewares.AutoAuthForDevMiddleware',  # Auto authentication middleware. 
    # 'root.middlewares.BlockIPMiddleware',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'anon': '10/hour',   # 10 requests/hour for unauthenticated users.
    }
}
...
# Login code validation time
LOGIN_CODE_LIFECYCLE = 5
# Email configuration
